import { Chrome, LogIn } from "@tamagui/lucide-icons-2";
    ...
    return (
        ...
        <YStack f={1} jc="center" bg="$background" pt={insets.top + 20} pb={insets.bottom + 20 as number}>
            ...
            <XStack jc="center" ai="center" gap="$2">
                <SizableText col="$colorMuted" fos="$3">Already have an account?</SizableText>
                <Link href="/sign_in">
                    <SizableText col="$secondary" fow="700" fos="$3">Sign In</SizableText>
                </Link>
            </XStack>
